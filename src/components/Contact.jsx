...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/919585822800?text=${whatsappMessage}`, '_blank');
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">+91 9585822800</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">artherbhion2004@gmail.com</p>
                  </div>
                </div>
              ...
              {status && (
                <div
                  className={`mt-4 text-center ${
                    status.includes("Opening") ? "text-green-400" : "text-red-400"
                  }`}
                >
                  <p>{status}</p>
                </div>
